"""
Django settings for projectm1 project.
...
SECRET_KEY = 'django-insecure-$7ii$%6+ey(dka0pqme#ul-ozitwfk5pt5ka4$(-*8gd2=dcq('
...
WSGI_APPLICATION = 'projectm1.wsgi.application'
